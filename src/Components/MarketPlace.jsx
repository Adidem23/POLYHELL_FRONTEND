            ...
            <div id='ZanduBaam2'>
                        ...
                        <>
                            <div className="cardop1" style={{ marginLeft: "20px", marginTop: "10px" }}>
                                <div className="cardop1-imgop1"><div className="imgop1"><img src={""} alt='Image is Not Loaded..' /></div></div>
                                <div className="cardop1-titleop1"></div>
                                <div className="cardop1-titleop1"></div>

                                <hr className="cardop1-dividerop1" />
                                <div className="cardop1-footerop1">
                                    <div className="cardop1-priceop1"><span> MATIC</span></div>
                                    <button className="cardop1-btnop1 ">
